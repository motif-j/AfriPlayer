/****************************************************************************
** Meta object code from reading C++ file 'qmd_qtrack.h'
**
...
#error "The header file 'qmd_qtrack.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 7, 16), // "trackNameChanged"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 9) // "trackName"

    },
    "QTrack\0trackNameChanged\0\0trackName"
};
...
void QTrack::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->trackNameChanged(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (QTrack::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QTrack::trackNameChanged)) {
                *result = 0;
                return;
            }
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QString*>(_v) = _t->getTrackName(); break;
        default: break;
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setTrackName(*reinterpret_cast< QString*>(_v)); break;
        default: break;
        }
